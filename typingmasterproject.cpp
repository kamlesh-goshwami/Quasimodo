...
//    fprintf(f4,"name",name,"accuracy",accuracy,"level ",level,"gross speed ",gross,"net speed ",net);
  fclose(f4);
...
void aboutme()
{
	cout<<"\nmyself roshan kumar sharma , i belong from jaipur and pursuing btech from nit agartala\n "<<endl;
}
int main()
{
	char c;
